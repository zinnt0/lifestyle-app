...
var _BottomTabsAccessory = _interopRequireDefault(require("./BottomTabsAccessory"));
var _BottomTabsAccessoryContent = _interopRequireDefault(require("./BottomTabsAccessoryContent"));
...
function BottomTabs(props) {
  ...
  }, filteredProps), filteredProps.children, bottomAccessory && _reactNative.Platform.OS === 'ios' && parseInt(_reactNative.Platform.Version, 10) >= 26 && (_reactNative.Platform.constants.reactNativeVersion.minor >= 82 ? /*#__PURE__*/_react.default.createElement(_BottomTabsAccessory.default, null, /*#__PURE__*/_react.default.createElement(_BottomTabsAccessoryContent.default, {
    environment: "regular"
  }, bottomAccessory('regular')), /*#__PURE__*/_react.default.createElement(_BottomTabsAccessoryContent.default, {
    environment: "inline"
  }, bottomAccessory('inline'))) : /*#__PURE__*/_react.default.createElement(_BottomTabsAccessory.default, {
